...
import { CategoriesType, MessageResponse, ProductsResponse, SearchProducts, SearchProductsResponse, AddNewProuduct, SingleProductResponse, UpdateProduct, DeleteProduct } from '../../types/ApiTypes'

export const productAPI = createApi({
  reducerPath: 'productApi',
  baseQuery: fetchBaseQuery({
    baseUrl: `${import.meta.env.BACKEND_SERVER}/api/v1/product`,
  }),
  tagTypes: ['product'],
  endpoints: (builder) => ({
