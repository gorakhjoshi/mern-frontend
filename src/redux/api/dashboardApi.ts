...
import { DashboardResponse, ProductsStatsResponse, SalesReportResponse, YearlyReportResponse } from '../../types/ApiTypes'

export const dashboardAPI = createApi({
  reducerPath: 'dashboardApi',
  baseQuery: fetchBaseQuery({
    baseUrl: `${import.meta.env.BACKEND_SERVER}/api/v1/dashboard`,
  }),
  tagTypes: ['dashboard'],
  endpoints: (builder) => ({
...
export const { useGetDashboardStatsQuery, useGetProductsStatsQuery, useGetSalesReportQuery, useGetYearlyReportQuery } = dashboardAPI
