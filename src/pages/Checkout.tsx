...
const CheckoutForm = () => {
  ...
  const { cartItems, subtotal, tax, discount, shippingCharges, total, shippingInfo } = useSelector((state: RootState) => state.cartReducer)
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="sm:w-[24rem] sm:mx-auto mx-5">
        ...
        <button type="submit" disabled={isProcessing} className="bg-black text-white w-full rounded py-1 my-3">
